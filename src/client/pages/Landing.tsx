      ...
      <div>
        ...
        <div>
          ...
          <div style={{height:"20vh", fontSize:"xxx-large", fontWeight:"bold", position:"relative", paddingTop:"20px"}}>
            <div style={{ color: "#00B979", textAlign:"center", marginTop:"30px"}}>Doing it right before your car breaks down!</div>
          </div>
          ...
          <div style={{ borderRadius: "25px", backgroundColor: "#cbc3c37a", margin: "10vw" }}>
